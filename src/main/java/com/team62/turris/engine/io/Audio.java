...
public class Audio {
    ...
    public static final String SND_TURRET_UPGRADE =
        "effects/turret_upgrade.wav";
    ...
    public static final String SND_ROUND_COMPLETE =
        "effects/round_complete.wav";
    ...
    public static void play(String filename) {
        ...
        if (muted) {
            ...
            switch (filename.substring(0, 2)) {
                case "m":
                    volume =
                        Main_menu.volume_music.getSliderWidth() /
                        Main_menu.volume_music.getMaxWidth();
                    break;
                default:
                    volume =
                        Main_menu.volume_sfx.getSliderWidth() /
                        Main_menu.volume_sfx.getMaxWidth();
                    break;
            }
        }
...
class Sound extends Thread {
    ...
    private long createBufferData(int p) throws UnsupportedAudioFileException {
        ...
        if (format.isBigEndian()) throw new UnsupportedAudioFileException(
        ...
        return (long) ((1000f * stream.getFrameLength()) /
            format.getFrameRate());
    }
