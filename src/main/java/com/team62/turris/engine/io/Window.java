...
public class Window {
    ...
    public void create() throws InterruptedException {
        ...
        System.out.println("Loading GLFW " + GLFW.glfwGetVersionString());
    ...
    public void setIcon(String path) {
        Image icon = Image.loadImage(path);
    ...
    public void finishUpdate() {
        ...
        for (int i = 0; i < GLFW.GLFW_MOUSE_BUTTON_LAST; i++) mouseButtons[i] =
            isMouseDown(i);
    }
    ...
    // Draws a live corner
    public void DrawGLRoundedCorner(
        float x,
        float y,
        double sa,
        double arc,
