        ...
        if (enabled) {
            if (
                ...
                if (
                    ...
                    // if (sliderWidth > max) sliderWidth = max; else if(sliderWidth < min)
                    // sliderWidth = min;
                    sliderWidth = Math.min(sliderWidth, max);
                    sliderWidth = Math.max(sliderWidth, min);
                }
            }
        }
    }
