...
import com.team62.turris.gui.*;
import com.team62.turris.level.handler.Load;
import com.team62.turris.playing.Playing;
import com.team62.turris.settings.io.Save;
...
public class Main_menu {
    ...
    public static Button website = new Button(
        "Website",
        480,
        400,
        170,
    ...
    public static Slider volume_sfx = new Slider(
        "Sound Effects: --",
        500,
        50,
        150,
    ...
    public static Button fullscreen = new Button(
        "Fullscreen",
        150,
        325,
        500,
    ...
    public static Button mute = new Button(
        "Toggle Mute",
        150,
        425,
        500,
    ...
    public static Slider volume_music = new Slider(
        "Music: --",
        500,
        50,
        150,
    ...
    public static void create() {
        ...
        mute.text = new Text(mute.getName(), mute.text.y, mute.text.y, 32);
            ...
            case ABOUT:
                ...
                if (github.updateClick()) {
                    if (
                        ...
                        try {
                            d.browse(
                                new URI("https://github.com/OleeL/Turris")
                            );
                ...
                if (website.updateClick()) {
                    if (
                        ...
                        try {
                            d.browse(
                                new URI(
                                    "https://student.csc.liv.ac.uk/~sgkbaker/Turris/Documentation.html"
                                )
                            );
                        } catch (IOException | URISyntaxException e) {
                            // TODO Auto-generated catch block
            ...
            case HELP:
                if (
                    ...
                    try {
                        d.browse(
                            new URI(
                                "https://student.csc.liv.ac.uk/~sgkbaker/Turris/Documentation.html#howtoplay"
                            )
                        );
                    } catch (IOException | URISyntaxException e) {
                        // TODO Auto-generated catch block
